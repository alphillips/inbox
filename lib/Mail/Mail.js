  ...
  function Mail(props) {
    ...
    _this.downloadFile = function (id) {
      api.getMailAttachment(id).then(function (data) {
        ...
        var fileData = fileHeader + data.data;
                  ...
                  _react2.default.createElement(
                    ...
                    reply.linkedAttachment.map(function (file, i) {
                      return _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('a', { id: "downloadLink" + file.externalRefId, download: file.name }),
                        _react2.default.createElement(
                          _reactRouter.Link,
                          { key: file.externalRefId, className: 'mail-attachment', onClick: _this3.downloadFile.bind(_this3, file.externalRefId) },
                          ' ',
                          file.name,
                          ' ',
                          " ",
