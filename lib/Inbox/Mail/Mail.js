  ...
  function Mail(props) {
    ...
    _this.handleSend = function () {
      ...
      api.sendMail(reply).then(function (data) {
        _this.setState(function (prevState, props) {
          return {
            success: 'Message ' + '"' + _this.state.subject + '"' + ' has been sent'
          };
        });
    ...
    _this.handleArchive = function (e) {
      ...
      api.setArchive(statusBody).then(function (data) {
        _this.setState(function (prevState, props) {
          return {
            success: 'Message ' + '"' + _this.state.mails[0].subject + '"' + ' has been archived'
          };
        });
        _this.props.callbackCloseSelf();
    ...
    _this.handleRestore = function (e) {
      ...
      api.setArchive(statusBody).then(function (data) {
        _this.setState(function (prevState, props) {
          return {
            success: 'Message ' + '"' + _this.state.mails[0].subject + '"' + ' has been unarchived'
          };
        });
        _this.props.callbackCloseSelf();
      }).catch(function (error) {
