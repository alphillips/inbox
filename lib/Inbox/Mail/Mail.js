  ...
  function Mail(props) {
    ...
    _this.handleSend = function () {
      ...
      api.sendMail(reply).then(function (data) {
        _this.props.setMessage({ success: 'Message ' + '"' + _this.state.subject + '"' + ' has been sent' }), _reactRouter.hashHistory.push('/inbox');
      });
    };
    ...
    _this.handleArchive = function (e) {
      ...
      api.setArchive(statusBody).then(function (data) {
        _this.props.setMessage({ success: 'Message ' + '"' + _this.state.mails[0].subject + '"' + ' has been archived' });
        _reactRouter.hashHistory.push('/inbox');
    ...
    _this.handleRestore = function (e) {
      ...
      api.setArchive(statusBody).then(function (data) {
        _this.props.setMessage({ success: 'Message ' + '"' + _this.state.mails[0].subject + '"' + ' has been unarchived' });
        _reactRouter.hashHistory.push('/inbox');
      }).catch(function (error) {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_ContentEditable2.default, { suppressContentEditableWarning: true, html: this.state.html, onChange: this.handleReplyContent, className: this.state.replyState ? "reply-area reply" : "reply-area" })
          ),
...
exports.default = (0, _PageWrapper2.default)()(Mail);
