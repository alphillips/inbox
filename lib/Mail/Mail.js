  ...
  Mail.prototype.componentDidMount = function componentDidMount() {
    ...
    if (this.state.type === "MESSAGE") {
      ...
      api.getMailFromAll(this.state.messageId).then(function (data) {
        var expiryDate = data.expiryTimestamp.epochSecond ? _this2.epochSecondToDate(data.expiryTimestamp.epochSecond, true) : "";
        var threadMessage = [];
        threadMessage.push(data);
        _this2.setState(function (prevState, props) {
          return {
          ...
          this.state.mails && this.state.mails.map(function (reply, i) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _this3.state.type === "MESSAGE" && reply.linkedAttachment && reply.linkedAttachment.length > 0 && _react2.default.createElement(
                  "span",
                  { className: "mail-date" },
                  "Attachment:",
                  _react2.default.createElement(
